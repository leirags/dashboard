...
import { Ecommerce, Calendar, ColorMapping, ColorPicker, Customers, Orders, Editor, Kanban, Employees } from './pages';
import { Area,Line,Bar,Pie,Pyramid,Financial,Stacked } from './pages';
